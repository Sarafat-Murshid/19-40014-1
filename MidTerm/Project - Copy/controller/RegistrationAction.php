...
if (!empty($firstname) && !empty($email) && !empty($username) && !empty($gender) && !empty($dob) && !empty($religion) && !empty($address) && !empty($_POST["confrimpass"]) && ($_POST["password"] == $_POST["confrimpass"])) {
        session_start();
        
        if (file_exists('../views/Users.json')) {
            $current_data = file_get_contents('../views/Users.json');
            ...
            if (file_put_contents('../views/Users.json', $final_data)) {
